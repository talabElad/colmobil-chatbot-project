...
class MasterAgent:
    ...
    def create_master_agent(self):
        ...
        [
            ...
            אתה מציע רכבים אך ורק מתוך מאגר המידע הפנימי של כלמוביל, ולכן לעולם אינך ממציא דגמים שאינם קיימים במאגר המידע הפנימי ה-SQL.
            ...
            בשאילתת הSQL תבקש 7 עמודות בשביל לדעת עוד פרטים על הרכבים.
            שמות העמודות לשימוש:
